...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1-2 | Vlan4094 | 10.253.2.19 | Port-Channel10 |
...
| Ethernet19 | host1_Eth1 | *trunk | *12,110,160 | *- | *- | 19 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SPINE1_Ethernet1 | routed | - | 10.255.0.37/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_SPINE2_Ethernet1 | routed | - | 10.255.0.39/31 | default | 1500 | False | - | - |
...
| Port-Channel19 | host1_PortChannel3 | switched | trunk | 12,110,160 | - | - | - | - | 19 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.254.0.10/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.254.1.10/32 |
| Loopback100 | Old_Gold_Ops_VTEP_DIAGNOSTICS | Old_Gold_Ops | 10.255.1.10/32 |
...
| Vlan3009 |  Old_Gold_Ops  |  10.253.0.18/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.253.0.18/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.253.2.18/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.254.0.10 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| 10.253.0.19 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Old_Gold_Ops | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Old_Gold_Ops | 10.254.0.10:10 | 10:10 | - | - | learned | 12,110 |
| Tenant_A_VMOTION | 10.254.0.10:55160 | 55160:55160 | - | - | learned | 160 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Old_Gold_Ops | 10.254.0.10:10 | connected |
...
router bgp 65101
   ...
   vrf Old_Gold_Ops
      ...
      router-id 10.254.0.10
      update wait-install
      neighbor 10.253.0.19 peer group MLAG-IPv4-UNDERLAY-PEER
...
| -------------- | --------------------- |
| Old_Gold_Ops | 10.255.1.10 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Old_Gold_Ops address 10.255.1.10
```
