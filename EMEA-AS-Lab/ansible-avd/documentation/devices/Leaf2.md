...
| Loopback100 | GOLD_VTEP_DIAGNOSTICS | GOLD | 10.255.1.2/32 |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| GOLD | 10.254.0.2:10 | 10:10 | - | - | learned | 12 |
...
```eos
!
ip address virtual source-nat vrf GOLD address 10.255.1.2
```
