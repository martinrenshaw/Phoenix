...
| Loopback100 | Old_Gold_Ops_VTEP_DIAGNOSTICS | Old_Gold_Ops | 10.255.1.3/32 |
...
| --- | ------------------- | ------------ |
| Old_Gold_Ops | 10.254.0.3:10 | connected |
...
| -------------- | --------------------- |
| Old_Gold_Ops | 10.255.1.3 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Old_Gold_Ops address 10.255.1.3
```
