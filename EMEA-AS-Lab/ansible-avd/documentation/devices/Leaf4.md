...
| Loopback100 | GOLD_VTEP_DIAGNOSTICS | GOLD | 10.255.1.4/32 |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| GOLD | 10.254.0.4:10 | 10:10 | - | - | learned | 34 |
...
```eos
!
ip address virtual source-nat vrf GOLD address 10.255.1.4
```
